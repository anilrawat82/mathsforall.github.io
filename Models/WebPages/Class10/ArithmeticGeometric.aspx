<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="ArithmeticGeometric.aspx.cs" Inherits="ArithmeticGeometric" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function SubmitAnswerA(id)
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class10/ArithmeticGeometric.aspx/GetSubmitAnswerA") %>';
        ...
        {
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class10/ArithmeticGeometric.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body onload="GenerateMatrix()">
        <div>
            <h1 class="PageNameHeading">Arithmetic Progression</h1>
        </div>
        <div>
            <table>
