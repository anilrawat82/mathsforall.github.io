<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="CoordinateGeometry.aspx.cs" Inherits="CoordinateGeometry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function SubmitAnswerA(id) {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class10/CoordinateGeometry.aspx/GetSubmitAnswerA") %>';
        ...
        function GenerateMatrix() {
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class10/CoordinateGeometry.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body onload="GenerateMatrix()">        
        ...
        <div id="MatrixArae" class="BackGround">
        </div>
