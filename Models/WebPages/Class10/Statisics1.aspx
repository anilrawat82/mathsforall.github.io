<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="Statisics1.aspx.cs" Inherits="Statisics1" %>
...
<link type="text/css" rel="stylesheet" href="../../Css/Common.css" />
    ...
    <script>
        function GenerateTableFB() {
            LastRow = -1;
            LastCol = -1;
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class10/Statisics1.aspx/GenerateMeanTable") %>';
            ...
            let MethodType = $('.SolutionTypeB:checked').val();
            JsonInput.iType = Number(TableType);
            JsonInput.iMethodType = Number(MethodType);
            ColumnSize = 2;
        ...
        function GenerateMatrix(id) {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class10/Statisics1.aspx/GenerateMatrix") %>';
            var xhttp = new XMLHttpRequest();
            xhttp.open("POST", pageUrl, true);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body>
        <div>
            <h1 class="PageNameHeading">Mean of Grouped Data</h1>
        </div>
        <div>
            <table>
              <tr>
        ...
        <table hidden  id="SolveTable">
             ...
             <tr class="AnswerTable">
                <td  class="InputIDSelection"> 
                        <label class="InputIDSelection">Select Method Type </label>
                </td>
                <td   class="InputIDSelection"> 
                    <input type="radio"  name="SolutionTypeC" value="1" checked="true" class="SolutionTypeB">
                    <label for="Forward">Direct Method</label><br>
                </td>
                 <td   class="InputIDSelection"> 
                    <input type="radio"  name="SolutionTypeC" value="2" class="SolutionTypeB">
                    <label for="Forward">Assumed Mean</label><br>
                </td>
                <td class="InputIDSelection"> 
                    <input type="radio"  name="SolutionTypeC" value="3" class="SolutionTypeB">
                    <label for="BackWard">Step-deviation</label><br>  
                </td>
            </tr>  
             <tr>
