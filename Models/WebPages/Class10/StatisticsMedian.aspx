<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="StatisticsMedian.aspx.cs" Inherits="StatisticsMedian" %>
...
<link type="text/css" rel="stylesheet" href="../../Css/Common.css" />
    ...
    <script>
        function GenerateTableFB() {
            LastRow = -1;
            LastCol = -1;
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class10/StatisticsMedian.aspx/GenerateMedianTable") %>';
        ...
        function GenerateMatrix(id) {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class10/StatisticsMedian.aspx/GenerateMatrix") %>';
            var xhttp = new XMLHttpRequest();
            xhttp.open("POST", pageUrl, true);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body>
        <div>
            <h1 class="PageNameHeading">Median of Grouped Data</h1>
        </div>
        <div>
            <table>
              <tr>
