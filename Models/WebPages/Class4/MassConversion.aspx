<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="MassConversion.aspx.cs" Inherits="MassConversion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function GenerateTestMatrix()
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/class4/MassConversion.aspx/GenerateTestYourselfMatrix") %>';
        ...
        function GenerateMatrix(id)
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/class4/MassConversion.aspx/GenerateMatrix") %>';
        ...
        {
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/class4/MassConversion.aspx/GetSubmitAnswer") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body>
        <div>
            <h1 class="PageNameHeading">MASS CONVERSION</h1>
        </div>
        <div>
            <table>
             <tr>
               ...
               <tr>
                ...
                <td   class="InputID"> 
                    ...
                    <label for="Forward">KG TO GRAM</label><br>
                </td>

                <td class="InputID"> 
                    <input type="radio"  name="SolutionType" value="2" class="SolutionTypeA">
                    <label for="BackWard">GRAM TO KG</label><br>  
                </td>
            </tr>
