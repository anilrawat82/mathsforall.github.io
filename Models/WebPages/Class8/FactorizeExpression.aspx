<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="FactorizeExpression.aspx.cs" Inherits="cFactorizeExpression" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function SubmitAnswer() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class8/FactorizeExpression.aspx/GetSubmitAnswer") %>';
        ...
        function GenerateTestMatrix() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class8/FactorizeExpression.aspx/GenerateTestYourselfMatrix") %>';
            var xhttp = new XMLHttpRequest();
            xhttp.open("POST", pageUrl, true);
            xhttp.setRequestHeader("Content-type", "application/json");
            const JsonInput =
        ...
        function GenerateMatrix(id) {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class8/FactorizeExpression.aspx/GenerateMatrix") %>';
            var xhttp = new XMLHttpRequest();
            xhttp.open("POST", pageUrl, true);
            xhttp.setRequestHeader("Content-type", "application/json");
            const JsonInput = {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body>
        <div>
            ...
            <h4 class="PageSubHeading">Find common factors for expression (Exercise=14.1.2) </h4>
        </div>
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <input id="txtExpression" type="text" name="txtStartNumber" value="5x^2y^2-15xy^2" class="MatrixOrder" />
