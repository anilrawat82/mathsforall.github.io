<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="SquareRootByPrimeFactorization.aspx.cs" Inherits="SquareRootByPrimeFactorization" %>
...
<link type="text/css" rel="stylesheet" href="../../Css/Common.css" />
    ...
    function HideElements(Id)
        ...
        function SubmitAnswer(ID)
        {
            ...
            ShowElements();
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class8/SquareRootByPrimeFactorization.aspx/GetSubmitAnswer") %>';
    ...
    function GenerateTestMatrix(ID)
    {
        ...
        var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class8/SquareRootByPrimeFactorization.aspx/GenerateTestYourselfMatrix") %>';
        var xhttp = new XMLHttpRequest();
        xhttp.open("POST", pageUrl, true);
        xhttp.setRequestHeader("Content-type", "application/json");
        const JsonInput =
        ...
        function GenerateMatrix(id,itype=0)
        {
            ...
            if (id == "txtSquareRoot" || id == "txtSquareRootMul" || id == "txtSquareRootDiv")
            {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Class8/SquareRootByPrimeFactorization.aspx/GenerateMatrix") %>';
            var xhttp = new XMLHttpRequest();
            xhttp.open("POST", pageUrl, true);
            xhttp.setRequestHeader("Content-type", "application/json");
            const JsonInput = {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <body>
        <div>
            <h1 class="PageNameHeading">Square Root through Prime factorisation</h1>
        </div>
        <div>
            <table>
                ...
                <tr>
                    <td colspan="3">
                        <input class="CTestYourSelf" id="btnCreate" type="button" value="Solve " onclick="GenerateMatrix('txtSquareRoot',0);" />
                    </td>
                </tr>
                <tr>
                    <td colspan="3" >
        ...
        <div>
           <table>
                <tr>
                    <td colspan="3">
                         <label class="InputIDA">Is the below number is Perfect Sqaure?if not find the smallest multiple of given number which is perfect square.Find the Square root of the new number</label>
                    </td>
                </tr>
                 <tr>
                    <td colspan="2">
                    ...
                    <td  >
                        ...
                        <input id="txtSquareRootMul" type="text" name="txtStartNumber" value="<%=sSquareRootMul%>" class="MatrixOrder" />
                ...
                <tr>
                    <td colspan="3">
                        <input class="CTestYourSelf" id="btnCreateA" type="button" value="Solve " onclick="GenerateMatrix('txtSquareRootMul', 1);" />
                    </td>
                </tr>
           </table>
        </div>
        <div id="MatrixArea1">
           ...
           <div>
               <table>
                    <tr>
                    <td colspan="3">
                         <label class="InputIDB">Is the below number is Perfect Sqaure?if not find the smallest number by which  given number must divided so that the number become perfect square.Find the Square root of the new number</label>
                    </td>
                </tr>
                 <tr>
                    <td colspan="2">
                    ...
                    <td>
                        ...
                        <input id="txtSquareRootDiv" type="text" name="txtStartNumber" value="<%=sSquareRootDiv%>" class="MatrixOrder" />
                 ...
                 <tr>
                    <td colspan="3">
                        <input class="CTestYourSelf" id="btnCreateB" type="button" value="Solve " onclick="GenerateMatrix('txtSquareRootDiv', 2);" />
                    </td>
                </tr>
