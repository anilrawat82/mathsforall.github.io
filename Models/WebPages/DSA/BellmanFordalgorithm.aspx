<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/DesignAlgo.Master" AutoEventWireup="true" CodeBehind="BellmanFordalgorithm.aspx.cs" Inherits="BellmanFordalgorithm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function ResetGraph() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/BellmanFordalgorithm.aspx/ResetGraph") %>';
        ...
        function GenerateFlowDigaram() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/BellmanFordalgorithm.aspx/GenerateFlowDigaram") %>';
            var xhttp = new XMLHttpRequest();
            xhttp.open("POST", pageUrl, true);
            xhttp.setRequestHeader("Content-type", "application/json");
            const JsonInput = {
        ...
        function AddSourceSink() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/BellmanFordalgorithm.aspx/AddSourceSinkElement") %>';
        ...
        function GenerateMatrix() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/BellmanFordalgorithm.aspx/AddNetworkFlow") %>';
            ...
            JsonInput.ip1 = (document.getElementById('FirstPoint_').value);
            JsonInput.ip2 = (document.getElementById('SecondPoint_').value);
        ...
        function GenrateCircle(event) {
            ...
            var x = event.offsetX;
            var y = event.offsetY;
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/BellmanFordalgorithm.aspx/GenerateGraphCircle") %>';
            var xhttp = new XMLHttpRequest();
            xhttp.open("POST", pageUrl, true);
            xhttp.setRequestHeader("Content-type", "application/json");
            const JsonInput = {
                 ...
                 <tr>
                      ...
                      <tr>
                       ...
                       <td style="width:400px">
                            ...
                            <input   id="btnCreateB" type="button" value="Add Source point " onclick="AddSourceSink();" class="MatrixOrder" style="width:300px"/>
                        </td>
                    </tr>
                    <tr>
