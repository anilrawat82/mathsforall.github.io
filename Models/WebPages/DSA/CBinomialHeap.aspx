<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/DesignAlgo.Master" AutoEventWireup="true" CodeBehind="CBinomialHeap.aspx.cs" Inherits="CBinomialHeap" %>
 ...
 <link type="text/css" rel="stylesheet" href="../../Css/Common.css" />
    ...
    <script>
        ...
        function GenerateMatrix(id)
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/CBinomialHeap.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <body>
        <div>
            <h1 class="PageNameHeading">BINOMIAL HEAP TREE</h1>
        </div>
        <div>
            <table>
             <tr>
