<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/DesignAlgo.Master" AutoEventWireup="true" CodeBehind="Dijkstra.aspx.cs" Inherits="Dijkstra" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function ResetGraph() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/Dijkstra.aspx/ResetGraph") %>';
        ...
        function GenerateFlowDigaram() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/Dijkstra.aspx/GenerateFlowDigaram") %>';
            var xhttp = new XMLHttpRequest();
            xhttp.open("POST", pageUrl, true);
            xhttp.setRequestHeader("Content-type", "application/json");
            const JsonInput = {
        ...
        function AddSourceSink() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/Dijkstra.aspx/AddSourceSinkElement") %>';
        ...
        function GenerateMatrix() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/Dijkstra.aspx/AddNetworkFlow") %>';
        ...
        function GenrateCircle(event) {
            ...
            var x = event.offsetX;
            var y = event.offsetY;
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/Dijkstra.aspx/GenerateGraphCircle") %>';
            var xhttp = new XMLHttpRequest();
            xhttp.open("POST", pageUrl, true);
            xhttp.setRequestHeader("Content-type", "application/json");
            const JsonInput = {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body>
      ...
      <div>
            <h1 class="PageNameHeading">DIJKSTRA's ALGORITHM</h1>
        </div>
        <div>
            <table>
             <tr>
