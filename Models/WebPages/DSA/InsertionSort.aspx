<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/DesignAlgo.Master" AutoEventWireup="true" CodeBehind="InsertionSort.aspx.cs" Inherits="InsertionSort" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function GenerateMatrix(id)
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/InsertionSort.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <body onload="SetLast_Number('hi')">
        <div>
            <h1 class="PageNameHeading">INSERTION SORT</h1>
        </div>
        <div>
            <table>
             <tr>
