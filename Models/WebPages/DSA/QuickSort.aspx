<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/DesignAlgo.Master" AutoEventWireup="true" CodeBehind="QuickSort.aspx.cs" Inherits="QuickSort" %>
    ...
    <link href="../../Css/LatestCommon.css" rel="stylesheet" />
     <script>
         ...
         function GenerateMatrix(id) {
             ...
             var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/QuickSort.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <body onload="SetLast_Number('hi')">
        <div>
            <h1 class="PageNameHeading">QUICK SORT</h1>
        </div>
        <div>
            <table>
             <tr>
