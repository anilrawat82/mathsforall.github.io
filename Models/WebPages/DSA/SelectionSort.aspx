<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/DesignAlgo.Master" AutoEventWireup="true" CodeBehind="SelectionSort.aspx.cs" Inherits="SelectionSort" %>
    ...
    <link type="text/css" rel="stylesheet" href="../../Css/NewMatrix.css" />
     <script>
         ...
         function GenerateMatrix(id) {
             ...
             var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/SelectionSort.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <body onload="SetLast_Number('hi')"
        <div>
            <h1 class="PageNameHeading">SELECTION SORT</h1>
        </div>
        <div>
            <table>
             <tr>
