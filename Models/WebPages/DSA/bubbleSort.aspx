<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/DesignAlgo.Master" AutoEventWireup="true" CodeBehind="bubbleSort.aspx.cs" Inherits="bubbleSort" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <script>
     ...
     function GenerateMatrix(id)
     {
         ...
         var pageUrl = '<%= ResolveUrl("~/Models/WebPages/DSA/bubbleSort.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <body onload="SetLast_Number('hi')">
        <div>
            <h1 class="PageNameHeading">BUBBLE SORT</h1>
        </div>
        <div>
            <table>
             <tr>
