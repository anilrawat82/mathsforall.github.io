<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="LCMSolution.aspx.cs" Inherits="LCMSolution" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function GenerateTestMatrix()
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/LCMSolution.aspx/GenerateTestYourselfMatrix") %>';
        ...
        function GenerateMatrix(id)
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/LCMSolution.aspx/GenerateMatrix") %>';
        ...
        {
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/LCMSolution.aspx/GetSubmitAnswer") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body>
        <div>
            <h1 class="PageNameHeading">Find The LCM of a Number</h1>
        </div>
        <div>
            <table>
             <tr>
               ...
               <tr>
                    <td>
                        <label class="InputID">Enter atleast 2 Numbers For LCM with comma Sepration like(23,36,45..) </label>
                    </td>
                    <td colspan="2">

                        <input id="txtLCMNumberS" type="text" name="txtMatrixOrder"  class="MatrixOrder" />
                  ...
                  <tr>
                    <td colspan="3">
                        ...
                        <input  class="CTestYourSelf" id="btnCreate" type="button" value="Solve " onclick="GenerateMatrix('txtLCMNumberS');" />
                        </td>
                    <%--<td><asp:TextBox runat="server" id="txtD"    /></td>--%>
                </tr>
                 <tr>
