<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="Mensuration2.aspx.cs" Inherits="Mensuration2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function SubmitAnswerA(id) {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/Mensuration2.aspx/GetSubmitAnswerA") %>';
        ...
        function GenerateMatrix() {
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/Mensuration2.aspx/GenerateMatrix") %>';
