<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="MissingNumbers.aspx.cs" Inherits="MissingNumbers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SubmitAnswer() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/MissingNumbers.aspx/GetSubmitAnswer") %>';
            ...
            xhttp.onload = function () {
                if (this.status == 200) {
                    ...
                    CheckMissingAnswer(str, ElementCount, QuestionCount);
        ...
        function GenerateMatrix() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/MissingNumbers.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body>
        <div>
            <h1 class="PageNameHeading">Find Missing Numbers </h1>
        </div>
        <div>
            <table>
               ...
               <tr>
                ...
                <%--<tr>
                    <td>
                        <label class="InputID">Number Of Questions B/W(1 to 15) </label>
                    </td>
                    <td colspan="2">
                ...
                <tr>
                    <td>
                        <label class="InputID">Number Of Elements B/W(3 to 10)</label>
                    </td>
                    <td colspan="2">
