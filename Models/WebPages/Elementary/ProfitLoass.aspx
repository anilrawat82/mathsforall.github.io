<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="ProfitLoass.aspx.cs" Inherits="ProfitLoass" %>
    ...
    <script type="text/javascript" src="../../JavaScript/Elementary.js"></script>
     <script>
         function SubmitAnswerA(id) {
             ...
             var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/ProfitLoass.aspx/GetSubmitAnswerA") %>';
         ...
         function GenerateMatrix() {
             var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/ProfitLoass.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <body onload="GenerateMatrix()">
         ...
         <div>
            <h1 class="PageNameHeading">Profit-Loss </h1>
        </div>
        <div>
