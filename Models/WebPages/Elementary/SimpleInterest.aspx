<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="SimpleInterest.aspx.cs" Inherits="SimpleInterest" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function SubmitAnswerA(id) {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/SimpleInterest.aspx/GetSubmitAnswerA") %>';
        ...
        function GenerateMatrix() {
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/SimpleInterest.aspx/GenerateMatrix") %>';
