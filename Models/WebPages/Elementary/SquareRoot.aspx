<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="SquareRoot.aspx.cs" Inherits="SquareRoot" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        {
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/SquareRoot.aspx/GetSubmitAnswer") %>';
        ...
        function GenerateTestMatrix() {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/SquareRoot.aspx/GenerateTestYourselfMatrix") %>';
    ...
    function GenerateMatrix(id)
        ...
        if (isNaN(iSquareRoot) == true ) {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Elementary/SquareRoot.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <body>
        <div>
            <h1 class="PageNameHeading">Square Root By Long Division Method</h1>
        </div>
        <div>
            <table>
                ...
                <tr>
                    <td>
                        <label class="InputID"> Number</label>
                    </td>
                    <td colspan="2">
