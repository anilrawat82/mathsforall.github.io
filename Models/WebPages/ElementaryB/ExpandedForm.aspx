<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/Master.Master" AutoEventWireup="true" CodeBehind="ExpandedForm.aspx.cs" Inherits="ExpandedForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link type="text/css" rel="stylesheet" href="../../Css/LatestCommon.css" />
    <link href="../../Css/ExpandNumber.css" rel="stylesheet" />
    <link type="text/css" rel="stylesheet" href="../../Css/Common.css" />
    <link type="text/css" rel="stylesheet" href="../../Css/CorrectAnswer.css" />
    
    <script type="text/javascript" src="../../JavaScript/Common.js"></script>
    <script src="../../JavaScript/ElementaryB.js"></script>
    ...
    <script>
        ...
        function GenerateTestMatrix()
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/ElementaryB/ExpandedForm.aspx/GenerateTestYourselfMatrix") %>';
        ...
        function GenerateMatrix(id) {
            ...
            if (id == "txtNumberS") {
                ...
                if (isNaN(iLCM_NUMBERS) == true || iLCM_NUMBERS <= 0 ) {
                    MatrixArea.innerHTML = "<h2 class=" + "\"ErrorText\"" + ">Please Enter Numeric Value </h2>";
                    return;
                }
                if ( iLCM_NUMBERS.length > 6) {
                    MatrixArea.innerHTML = "<h2 class=" + "\"ErrorText\"" + ">You can enter value upto 6 digits only ,Current length is " + iLCM_NUMBERS.length  +"</h2>";
                    return;
                }
            }
            else {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/ElementaryB/ExpandedForm.aspx/GenerateMatrix") %>';
            ...
            JsonInput.dNumber = iLCM_NUMBERS;
        ...
        function SubmitAnswer() {
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/ElementaryB/ExpandedForm.aspx/GetSubmitAnswer") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body>
        <div>
            <h1 class="PageNameHeading">Expanded Form of a Number</h1>
        </div>
        <div>
            <table>
             <tr>
               ...
               <tr>
                    <td>
                        <label class="InputID">Number(only natural number Maximum 6 digit number)</label>
                    </td>
                    <td colspan="2">
