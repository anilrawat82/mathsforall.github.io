<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="Determinant.aspx.cs" Inherits="Determinant" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function FindDeterminant()
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/Matrices/Determinant.aspx/SolveDeterminant") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
         <div>
            <h1 class="PageNameHeading">DETERMINANT</h1>
        </div>
           <div>
            <table>
             <tr>
               ...
               <tr>
                    <td class ="tdA">
                        <label class="InputID">Determinant Order example 2,3, so on </label>
                    </td>
