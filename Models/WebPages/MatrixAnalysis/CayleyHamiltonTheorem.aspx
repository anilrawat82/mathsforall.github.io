<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="CayleyHamiltonTheorem.aspx.cs" Inherits="CayleyHamiltonTheorem" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            //FirstTime = true;
            let FindValue = Number(document.getElementById("txtFindValue").value);
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/MatrixAnalysis/CayleyHamiltonTheorem.aspx/CayleyHamilton") %>';
            ...
            MatrixDeterminant.iFindValue = Number(FindValue);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
         <div>
            <h1 class="PageNameHeading">Cayley Hamilton Theorem</h1>
        </div>
           <div>
            <table>
             <tr>
                 ...
                 <tr>
                    <td class ="tdA">
                        <label class="InputID">Matrix of order example 2,3, so on </label>
                    </td>
                ...
                <tr>
                    <td class ="tdA">
                        <label class="InputID" >Find the Value of A<sup>-1</sup>,A<sup>2</sup>,A<sup>3</sup> etc </label>
                    </td>
                    <td colspan="2" class ="tdA">
                        <input id="txtFindValue" name="txtMatrixOrder"  class="MatrixOrder" type="number" />
                  ...
                  <tr>
                    <td colspan="3" class ="tdA">
                        <label class="Notes2">Note:Use for fInding Inverse of Matrix A<sup>-1</sup> or Power of Matrix A<sup>2</sup>,A<sup>3</sup> etc.</label>
