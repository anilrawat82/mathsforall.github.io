<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="CramersRule.aspx.cs" Inherits="CramersRule" %>
    ...
    <script type="text/javascript">
        ...
        function FindSolution()
        {
            ...
            else
            {
                ...
                MyMatrixA = "1:3:1:10:1:-2:-1:-6:2:1:2:10";
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/MatrixAnalysis/CramersRule.aspx/SolveSystemofEquation") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
         <div>
            <h1 class="PageNameHeading">Cramer Rule</h1>
        </div>
           <div>
            <table>
             <tr>
