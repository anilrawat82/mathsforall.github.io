<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="GaussElimination.aspx.cs" Inherits="GaussElimination" %>
...
<script type="text/javascript" src="../../JavaScript/Jquery.js"></script>
    ...
    <script type="text/javascript">
        ...
        function FindSolution()
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/MatrixAnalysis/GaussElimination.aspx/SolveSystemofEquation") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
         <div>
            <h1 class="PageNameHeading">Gauss Elimination</h1>
        </div>
           <div>
            <table>
             <tr>
