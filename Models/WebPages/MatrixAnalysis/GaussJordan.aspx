<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="GaussJordan.aspx.cs" Inherits="GaussJordan" %>
...
<script type="text/javascript" src="../../JavaScript/Jquery.js"></script>
    ...
    <script type="text/javascript">
        ...
        function FindSolution()
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/MatrixAnalysis/GaussJordan.aspx/SolveSystemofEquation") %>';
