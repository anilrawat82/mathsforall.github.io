<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="GaussJordanInverse.aspx.cs" Inherits="GaussJordanInverse" %>
...
<script type="text/javascript" src="../../JavaScript/Jquery.js"></script>
    ...
    <script type="text/javascript">
        ...
        function FindSolution()
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/MatrixAnalysis/GaussJordanInverse.aspx/SolveSystemofEquation") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
         <div>
            <h1 class="PageNameHeading">Gauss Jordan</h1>
        </div>
           <div>
            <table>
             <tr>
