<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="LuDecomposition.aspx.cs" Inherits="LuDecomposition" %>
...
<script type="text/javascript" src="../../JavaScript/Jquery.js"></script>
    ...
    <script type="text/javascript">
        ...
        let FirstTime = false;
        let MyMatrixA = "";
        function SolveForLUDecompose(Values) {
        ...
        {
            MatrixOrder= Number(document.getElementById("txtMatrixOrder").value);
            ...
            else
            {
                ...
                //MyMatrixA = "2:3:1:1:2:3:3:1:2";
                //MyMatrixA = "2:3:1:2:1:2:3:4:1:3:2:3:4:1:2:1:1:3:2:1:1:2:3:1:1";
                //MyMatrixA = "2:6:1:2:1:2:5:4:1:3:2:3:4:1:2:1:1:3:2:1:1:2:3:1:1";
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/MatrixAnalysis/LuDecomposition.aspx/SolveSystemofEquation") %>';
            ...
            MatrixDeterminant.sMatrixA = MyMatrixA;
            ...
            //    if (this.status == 200) {
                    ...
                    LuSolution = answer[1].split("###");
                    MatrixArea.innerHTML = answer[0];
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
         <div>
            <h1 class="PageNameHeading">LU Decomposition</h1>
        </div>
           <div>
            <table>
             <tr>
