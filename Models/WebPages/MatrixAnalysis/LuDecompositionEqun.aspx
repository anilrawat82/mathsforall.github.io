<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="LuDecompositionEqun.aspx.cs" Inherits="LuDecompositionEqun" %>
...
<script type="text/javascript" src="../../JavaScript/Jquery.js"></script>
    ...
    <script type="text/javascript">
        ...
        function FindSolution()
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/MatrixAnalysis/LuDecompositionEqun.aspx/SolveSystemofEquation") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
         <div>
            <h1 class="PageNameHeading">LU Decomposition Method</h1>
        </div>
           <div>
            <table>
             <tr>
               ...
               <tr>
                  ...
                  <tr>
                    <td colspan="3" class ="tdA">
                        <input  class="CTestYourSelf" id="btnCreate" type="button" value="Generate Input Values Matrix " onclick="GenerateEquationSystem(1,1);"  />
                    </td>
                </tr>        
