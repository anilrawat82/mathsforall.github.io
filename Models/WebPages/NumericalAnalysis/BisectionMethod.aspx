<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="BisectionMethod.aspx.cs" Inherits="BisectionMethod" %>
    ...
    function GenerateMatrix(id)
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/NumericalAnalysis/BisectionMethod.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body onload="SetLast_Equation('hi')">
        <div>
            <h1 class="PageNameHeading">BISECTION METHOD</h1>
        </div>
        <div>
            <table>
             <tr>
