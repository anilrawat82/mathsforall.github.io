<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="HermiteInterpolation.aspx.cs" Inherits="HermiteInterpolation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function FindSolution() {
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/NumericalAnalysis/HermiteInterpolation.aspx/FindSolution") %>';
        ...
        function GenerateMatrix(id)
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/NumericalAnalysis/HermiteInterpolation.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body>
        <div>
            <h1 class="PageNameHeading">Hermite Interpolation</h1>
        </div>
