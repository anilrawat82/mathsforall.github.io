<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="NewtonForwardBackwardSol.aspx.cs" Inherits="NewtonForwardBackwardSol" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function GenerateTableFB() {
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/NumericalAnalysis/NewtonForwardBackwardSol.aspx/GenerateNewtonTable") %>';
        ...
        function GenerateMatrix(id) {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/NumericalAnalysis/NewtonForwardBackwardSol.aspx/GenerateMatrix") %>';
