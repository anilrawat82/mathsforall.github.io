<%@ Page Title="" Language="C#" MasterPageFile="~/Models/WebPages/NumericalAnalysis.Master" AutoEventWireup="true" CodeBehind="RamanujanMethod.aspx.cs" Inherits="RamanujanMethod" %>
    ...
    function GenerateMatrix(id)
        {
            ...
            var pageUrl = '<%= ResolveUrl("~/Models/WebPages/NumericalAnalysis/RamanujanMethod.aspx/GenerateMatrix") %>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <body>
      <div>
         <div>
            <h1 class="PageNameHeading">Ramanujan's Method</h1>
        </div>
           <div>
            <table>
             <tr>
